      ...
      <div className="container-max relative z-10">
        ...
        >
          ...
          <div className="flex flex-col gap-5 max-w-2xl relative z-10">
            ...
            >
              Have an idea?{' '}
              <span className="text-[#6dffba]">Let's build it.</span>
            </h2>

            <p className="text-[16px] text-[#bacbbe] leading-relaxed">
              Tell us what you're trying to build, improve, or automate. We'll map the exact architecture and engineer the technology with you.
            </p>
            ...
            <div className="flex items-center gap-3 text-[#849589] text-[13px]">
              ...
              <span style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                Talk directly with the engineers building your software — no sales reps or project managers in between.
              </span>
            </div>
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              ...
              <span className="flex items-center gap-2 text-[#bacbbe] text-[13px]">
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col items-stretch sm:items-center lg:items-stretch gap-4 w-full lg:w-auto lg:min-w-[220px] relative z-10 flex-shrink-0">
            ...
            <div className="flex items-center gap-3 justify-center pt-2">
              ...
              <a
                href="#"
                className="w-9 h-9 rounded-lg bg-[#1a1b21] border border-[#292a2f] flex items-center justify-center text-[#849589] hover:text-[#7bd0ff] hover:border-[#3b4a41] transition-all"
                aria-label="LinkedIn"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
