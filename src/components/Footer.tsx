        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3 mt-1">
              ...
              <span
                className="w-8 h-8 rounded-lg bg-[#1a1b21] border border-[#292a2f] border-dashed flex items-center justify-center text-[#4d4f57] cursor-not-allowed select-none"
                aria-disabled="true"
                title={`${f.linkedin} — ${f.comingSoon}`}
              >
